        ...
        <div onClick={handleBar} className={`sm:hidden border-2 rounded duration-300 ${barshow ? "border-[#8F9CFF]" : "border-[#DE85C8]"}`}>
         {
          ...
          <GiSplitCross className="text-[#8F9CFF]"/>
            ...
            <ul className={`sm:flex sm:static absolute bg-[#c7c7c74a] sm:backdrop-blur-none backdrop-blur-xl sm:rounded-none rounded-xl sm:p-0 p-[40px] sm:w-fit w-[310px] sm:right-0        ${barshow ? "top-[-350px]" : "top-[60px]"} sm:h-0 h-[350px] duration-300 z-10 sm:items-center lg:gap-[40px] md:gap-[25px] sm:gap-[12px]  sm:text-start text-center text-primary font-inter lg:text-[15px] md:text-[11px] sm:text-[10px] text-[13px] font-medium`}>
